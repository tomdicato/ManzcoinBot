...
def get_collection_transfers(slug = "manzcoin-nftz", event_type="successful", delay = 400):
    ...
    if str(response.status_code)=="200":
        ...
        if len(df.index)>0:
            ...
            transaction_list = df_transaction[df_transaction['to_account_address'] != '0x7be8076f4ea4a4ad08075c2508e481d6c946d12b']
            df_transaction.to_csv("manz_transaction.csv")

            df_transaction[['from_account_user_username', 'to_account_user_username', 'to_account_config', 'to_account_address']]
